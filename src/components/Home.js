    ...
    >
      ...
      <Accordion style={{ width: "80vw" }}>
        ...
        <Accordion.Item eventKey="13">
          <Accordion.Header>
            <AiFillFileMarkdown style={{ marginRight: "10px" }} /> Markdown Editor
          </Accordion.Header>
          <Accordion.Body>
            <p>
            Markdown editor designed for users who need to write, preview, and download markdown text. The component features a dual-pane interface where users can input their markdown on one side and see a live preview of the rendered HTML on the other. It offers seamless options to download the content in various formats. This component is particularly useful for viewing or downloading text generated by ChatGPT as PDF, HTML, or DOC. It provides an easy way to take markdown-formatted text and export it into widely-used document formats, making it ideal for sharing or storing information generated in ChatGPT.
            </p>
            <Link to="/markdown-editor">
              <OverlayTrigger placement="right" overlay={renderTooltip}>
                <Button variant="primary" style={{boxShadow: "none", outline: "none"}}>Markdown Editor</Button>
              </OverlayTrigger>
            </Link>
          </Accordion.Body>
        </Accordion.Item>
